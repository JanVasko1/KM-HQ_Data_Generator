...
def Download_Data_Purchase_Orders(Settings: dict, Configuration: dict, window: CTk, Progress_Bar: CTkProgressBar, NUS_version: str, NOC: str, Environment: str, Company: str, Purchase_Order_list: list) -> list[DataFrame]:
    ...
    if HQ_Communication_Setup_df.empty:
        ...
        HQ_Communication_Setup_df = HQ_Communication_Setup_df.drop_duplicates()
    ...
    if Can_Process == True:
        ...
        if NVR_FS_Connect_df.empty:
            ...
            # Drop Duplicate rows amd reset index
            NVR_FS_Connect_df = NVR_FS_Connect_df.drop_duplicates()
    ...
    if Can_Process == True:
        ...
        if Purchase_Headers_df.empty:
            ...
            # Drop Duplicate rows amd reset index
            Purchase_Headers_df = Purchase_Headers_df.drop_duplicates()
    ...
    if Can_Process == True:
        ...
        if Purchase_Lines_df.empty:
            ...
            # Drop Duplicate rows amd reset index
            Purchase_Lines_df = Purchase_Lines_df.drop_duplicates()
    ...
    if Can_Process == True:
        ...
        if HQ_Item_Transport_Register_df.empty:
            ...
            # Drop Duplicate rows amd reset index
            HQ_Item_Transport_Register_df = HQ_Item_Transport_Register_df.drop_duplicates()
    ...
    if Can_Process == True:
        ...
        # Drop Duplicate rows
        Items_Price_List_Detail_df = Items_Price_List_Detail_df.drop_duplicates()
...
def Download_Data_BackBoneBilling(Settings: dict, Configuration: dict, window: CTk, Progress_Bar: CTkProgressBar, NUS_version: str, NOC: str, Environment: str, Company: str, Buy_from_Vendor_No_list: list) -> list[DataFrame]:
    ...
    if Can_Process == True:
        ...
        if Vendor_Service_Function_df.empty:
            ...
            # Drop Duplicate rows amd reset index
            Vendor_Service_Function_df = Vendor_Service_Function_df.drop_duplicates()
