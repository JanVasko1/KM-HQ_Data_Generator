    ...
    if Can_Continue == True:
        if PO_Numbers_Method == "Fixed":
            ...
            if GUI == True:
                ...
                raise APIError(message="Any Prompt method is not allowed in API calls. Issue in Generate_PO_CON_Header:Confirmation_Number", status_code=500, charset="utf-8")
        else:
            if GUI == True:
                ...
                raise APIError(message=f"Confirmation Number Method selected: {PO_Numbers_Method} which is not supporter. Cancel File creation.", status_code=500, charset="utf-8")
            Can_Continue = False
    ...
    if Can_Continue == True:
        if PO_Generation_Date_Method == "Fixed":
            ...
            if GUI == True:
                ...
                raise APIError(message=f"Any Prompt method is not allowed in API calls. Issue in Generate_PO_CON_Header:Generation_Date.", status_code=500, charset="utf-8")
        else:
            if GUI == True:
                ...
                raise APIError(message=f"Generation Date Method selected: {PO_Generation_Date_Method} which is not supporter. Cancel File creation.", status_code=500, charset="utf-8")
            Can_Continue = False
    ...
    if Can_Continue == True:
        if PO_Currency_Method == "Fixed":
            ...
            if GUI == True:
                ...
                raise APIError(message=f"Currency Method selected: {PO_Currency_Method} which is not supporter. Cancel File creation.", status_code=500, charset="utf-8")
            Can_Continue = False
