...
def Settings_User_Access(Settings: dict, Configuration: dict, window: CTk, Frame: CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    Data_Functions.Entry_field_Insert(Field=NAV_Display_name_Frame_Var, Value=Display_name)
    ...
    Data_Functions.Entry_field_Insert(Field=NAV_Client_ID_Frame_Var, Value=client_id)
    ...
    Data_Functions.Entry_field_Insert(Field=NAV_Client_Secret_Frame_Var, Value=client_secret)
