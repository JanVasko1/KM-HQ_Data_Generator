...
def General(Settings: dict, Configuration: dict, Frame: CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    CPDI_Delivery_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Method", Field_Type="Input_OptionMenu") 
    ...
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=CPDI_Delivery_Frame_Var, values=CPDI_Delivery_Method_List, command=lambda CPDI_Delivery_Frame_Var: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Documents=None, Variable=CPDI_Delivery_Method_Variable, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "CPDI", "Delivery_select", "Method"], Information=CPDI_Delivery_Frame_Var), GUI_Level_ID=GUI_Level_ID)

    # Field - Fixed Delivery
    Fixed_Delivery_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Fixed Delivery", Field_Type="Input_Normal") 
    ...
    Fixed_Delivery_Frame_Var.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Documents=None, Variable=None, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "CPDI", "Delivery_select", "Fixed_Options", "Fix_Delivery"], Information=Fixed_Delivery_Frame_Var.get()))
    ...
    # Field -Level Method
    CPDI_Level_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Method", Field_Type="Input_OptionMenu") 
    ...
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=CPDI_Level_Frame_Var, values=CPDI_Level_Method_List, command=lambda CPDI_Level_Frame_Var: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Documents=None, Variable=CPDI_Level_Method_Variable, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "CPDI", "Level_Provided", "Method"], Information=CPDI_Level_Frame_Var), GUI_Level_ID=GUI_Level_ID)

    # Field - Fixed Level
    Fixed_Level_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Fixed Level", Field_Type="Input_Normal") 
    ...
    Fixed_Level_Frame_Var.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Documents=None, Variable=None, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "CPDI", "Level_Provided", "Fixed_Options", "Fix_Level"], Information=Fixed_Level_Frame_Var.get()))
    ...
    # Field - Number Method
    CPDI_Status_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Method", Field_Type="Input_OptionMenu") 
    ...
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=CPDI_Status_Frame_Var, values=CPDI_Status_Method_List, command=lambda CPDI_Status_Frame_Var: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Documents=None, Variable=CPDI_Status_Method_Variable, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "CPDI", "Status", "Method"], Information=CPDI_Status_Frame_Var), GUI_Level_ID=GUI_Level_ID)

    # Field - Fixed Delivery
    Fixed_Status_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Fixed Status", Field_Type="Input_Normal") 
    ...
    Fixed_Status_Frame_Var.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Documents=None, Variable=None, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "CPDI", "Status", "Fixed_Options", "Fix_Status"], Information=Fixed_Status_Frame_Var.get()))
