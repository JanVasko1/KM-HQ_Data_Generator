...
def General(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame) -> CTkFrame:
    # ---------------------------- Defaults ----------------------------#
    ...
    # ------------------------- Main Functions -------------------------#
    # Frame - General
    Frame_Main = Elements_Groups.Get_Widget_Frame(Configuration=Configuration, Frame=Frame, Name="Generate", Additional_Text="", Widget_size="Single_size", Widget_Label_Tooltip="Settings related what CPDI status should be created.")
