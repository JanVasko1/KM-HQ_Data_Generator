...
def BB_INV_Number(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=BB_INV_Number_Frame_Var, values=BB_Numbers_Method_List, command=lambda BB_INV_Number_Frame_Var: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=BB_Numbers_Method_Variable, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "Invoice", "BackBone_Billing", "Number", "Method"], Information=BB_INV_Number_Frame_Var), GUI_Level_ID=GUI_Level_ID)
    ...
    BB_NUM_INV_FIX_Frame_Var.bind("<FocusOut>", lambda BB_Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "Invoice", "BackBone_Billing", "Number", "Fixed_Options", "Number"], Information=BB_NUM_INV_FIX_Frame_Var.get()))
    ...
    BB_AUT_Prefix_Frame_Var.bind("<FocusOut>", lambda BB_Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "Invoice", "BackBone_Billing", "Number", "Automatic_Options", "Prefix"], Information=BB_AUT_Prefix_Frame_Var.get()))
...
def BB_Items(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=BB_Items_Method_Frame_Var, values=BB_Items_Method_List, command=lambda BB_Items_Method_Frame_Var: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=BB_Items_Method_Variable, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "Invoice", "BackBone_Billing", "Items", "Method"], Information=BB_Items_Method_Frame_Var), GUI_Level_ID=GUI_Level_ID)
    ...
    BB_Fixed_Items_Frame_Var.bind("<FocusOut>", lambda BB_Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "Invoice", "BackBone_Billing", "Items", "Fixed_Options", "Fix_Item"], Information=BB_Fixed_Items_Frame_Var.get()))
...
def BB_Quantity(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=BB_Quantity_Method_Frame_Var, values=BB_Quantity_Method_List, command=lambda BB_Quantity_Method_Frame_Var: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=BB_Quantity_Method_Variable, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "Invoice", "BackBone_Billing", "Quantity", "Method"], Information=BB_Quantity_Method_Frame_Var), GUI_Level_ID=GUI_Level_ID)
...
def BB_Price_Currency(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=BB_Prices_Method_Frame_Var, values=BB_Price_Method_List, command=lambda BB_Prices_Method_Frame_Var: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=BB_Price_Method_Variable, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "Invoice", "BackBone_Billing", "Prices", "Method"], Information=BB_Prices_Method_Frame_Var), GUI_Level_ID=GUI_Level_ID)
    ...
    BB_Fixed_Price_Frame_Var.bind("<FocusOut>", lambda BB_Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "Invoice", "BackBone_Billing", "Prices", "Fixed_Options", "Fix_Price"], Information=int(BB_Fixed_Price_Frame_Var.get())))
    ...
    BB_Fixed_Currency_Frame_Var.bind("<FocusOut>", lambda BB_Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "Invoice", "BackBone_Billing", "Currency", "Fix_Currency"], Information=BB_Fixed_Currency_Frame_Var.get()))
...
def BB_Posting_Date(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=BB_Invoice_Date_Method_Frame_Var, values=BB_Posting_Date_Method_List, command=lambda BB_Invoice_Date_Method_Frame_Var: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=BB_Posting_Date_Method_Variable, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "Invoice", "BackBone_Billing", "Posting_Date", "Method"], Information=BB_Invoice_Date_Method_Frame_Var), GUI_Level_ID=GUI_Level_ID)
    ...
    BB_PD_Fixed_Date_Frame_Var.bind("<FocusOut>", lambda BB_Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "Invoice", "BackBone_Billing", "Posting_Date", "Fixed_Options", "Fix_Date"], Information=BB_PD_Fixed_Date_Frame_Var.get()))
...
def BB_Order_reference(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=BB_Order_id_Method_Frame_Var, values=BB_Order_id_Method_List, command=lambda BB_Order_id_Method_Frame_Var: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=BB_Order_id_Method_Variable, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "Invoice", "BackBone_Billing", "Order_reference", "Order_id", "Method"], Information=BB_Order_id_Method_Frame_Var), GUI_Level_ID=GUI_Level_ID)
...
def BB_Plant(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=BB_Inv_Plant_Fixed_Frame_Var, values=BB_Inv_Fixed_Plants_List, command=lambda BB_Inv_Plant_Fixed_Frame_Var: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=BB_Inv_Fixed_Plant_Variable, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "Invoice", "BackBone_Billing", "Plants", "Fixed_Options", "Fixed_Plant"], Information=BB_Inv_Plant_Fixed_Frame_Var), GUI_Level_ID=GUI_Level_ID)
...
def BB_CountryOrigin(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=BB_Count_Origin_Method_Frame_Var, values=BB_Count_Origin_Method_List, command=lambda BB_Count_Origin_Method_Frame_Var: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=BB_Count_Origin_Method_Variable, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "Invoice", "BackBone_Billing", "Country_Of_Origin", "Method"], Information=BB_Count_Origin_Method_Frame_Var), GUI_Level_ID=GUI_Level_ID)
...
def BB_Tariff(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    Elements.Get_Option_Menu_Advance(Configuration=Configuration, attach=BB_Tariff_Method_Frame_Var, values=BB_Tariff_Method_List, command=lambda BB_Tariff_Method_Frame_Var: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=BB_Tariff_Method_Variable, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "Invoice", "BackBone_Billing", "Tariff", "Method"], Information=BB_Tariff_Method_Frame_Var), GUI_Level_ID=GUI_Level_ID)
    ...
    BB_Fixed_Tariff_Frame_Var.bind("<FocusOut>", lambda BB_Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "Invoice", "BackBone_Billing", "Tariff", "Fixed_Options", "Fix_Tariff"], Information=BB_Fixed_Tariff_Frame_Var.get()))
