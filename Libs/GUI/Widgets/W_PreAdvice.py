...
def Delivery_Date(Settings: dict, Configuration: dict, Frame: CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    Pre_Fixed_Date_Frame_Var.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Documents=None, Variable=None, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "PreAdvice", "Delivery_Date", "Fixed_Options", "Fix_Date"], Information=Pre_Fixed_Date_Frame_Var.get()))
    ...
    Pre_Random_From_Frame_Var.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Documents=None, Variable=None, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "PreAdvice", "Delivery_Date", "Random_Options", "From"], Information=int(Pre_Random_From_Frame_Var.get())))
    Entry_field_Insert(Field=Pre_Random_From_Frame_Var, Value=Pre_Rand_From_Date)

    # Field - Delivery Date - To CD + Entry Field
    Pre_Random_To_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Date - To CD +", Field_Type="Input_Normal", Validation="Integer") 
    ...
    Pre_Random_To_Frame_Var.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Documents=None, Variable=None, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "PreAdvice", "Delivery_Date", "Random_Options", "To"], Information=int(Pre_Random_To_Frame_Var.get())))
