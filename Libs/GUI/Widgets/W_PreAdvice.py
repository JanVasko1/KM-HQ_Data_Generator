...
def Delivery_Date(Settings: dict, Configuration: dict, window: CTk, Frame: CTkFrame, GUI_Level_ID: int|None = None) -> CTkFrame:
    ...
    Data_Functions.Entry_field_Insert(Field=Pre_Fixed_Date_Frame_Var, Value=Pre_Fix_Date)
    ...
    Data_Functions.Entry_field_Insert(Field=Pre_Random_From_Frame_Var, Value=Pre_Rand_From_Date)
    ...
    Data_Functions.Entry_field_Insert(Field=Pre_Random_To_Frame_Var, Value=Pre_Rand_To_Date)
    ...
    Pre_Del_Shift_Frame_Var.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Documents=None, window=window, Variable=None, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "PreAdvice", "Delivery_Date", "Shift_Options", "Delivery_Date_Shift_by"], Information=int(Pre_Del_Shift_Frame_Var.get())))
    Data_Functions.Entry_field_Insert(Field=Pre_Del_Shift_Frame_Var, Value=Pre_Delivery_Shift)

    # Field - Delivery Date Shift by Entry field
    Pre_Gen_Shift_Frame = Elements_Groups.Get_Widget_Input_row(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Body, Field_Frame_Type="Single_Column" , Label="Generation Date shift by", Field_Type="Input_Normal", Validation="Integer") 
    Pre_Gen_Shift_Frame_Var = Pre_Gen_Shift_Frame.children["!ctkframe3"].children["!ctkentry"]
    Pre_Gen_Shift_Frame_Var.configure(placeholder_text="Number of Days (minus)", placeholder_text_color="#949A9F")
    Pre_Gen_Shift_Frame_Var.bind("<FocusOut>", lambda Entry_value: Data_Functions.Save_Value(Settings=Settings, Configuration=None, Documents=None, window=window, Variable=None, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "PreAdvice", "Delivery_Date", "Shift_Options", "Generation_Date_Shift_by"], Information=int(Pre_Gen_Shift_Frame_Var.get())))
    Data_Functions.Entry_field_Insert(Field=Pre_Gen_Shift_Frame_Var, Value=Pre_Gen_Date_Shift)
