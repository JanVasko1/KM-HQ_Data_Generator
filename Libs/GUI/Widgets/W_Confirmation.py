...
def PO_CON_Number(Settings: dict, Configuration: dict|None, window: CTk|None, Frame: CTkFrame, GUI_Level_ID: int|None = None) -> WidgetFrame:
    ...
    CON_Number_Row = WidgetRow_OptionMenu(Settings=Settings, Configuration=Configuration, master=Con_Number_Widget.Body_Frame, window=window, Field_Frame_Type="Single_Column", Label="Method", Variable=Numbers_Method_Variable, Values=Numbers_Method_List, Save_To="Settings", Save_path=["0", "HQ_Data_Handler", "Confirmation", "Purchase_Order", "Number", "Method"], Field_list=[NUM_CON_FIX_Row, AUT_Prefix_Row], Field_Blocking_dict=Fields_Blocking_dict, GUI_Level_ID=GUI_Level_ID) 
...
def PO_Generation_Date(Settings: dict, Configuration: dict|None, window: CTk|None, Frame: CTkFrame, GUI_Level_ID: int|None = None) -> WidgetFrame:
    ...
    Fields_Blocking_dict = CustomTkinter_Functions.Fields_Blocking(Values=["Fixed", "Today", "Prompt"], Freeze_fields=[[],[Gen_Fixed_Date_Row],[Gen_Fixed_Date_Row]])
    CON_Date_Method_Row = WidgetRow_OptionMenu(Settings=Settings, Configuration=Configuration, master=Con_Gen_Date_Widget.Body_Frame, window=window, Field_Frame_Type="Single_Column", Label="Method", Variable=Generation_Date_Method_Variable, Values=Generation_Date_Method_List, Save_To="Settings", Save_path=["0", "HQ_Data_Handler", "Confirmation", "Purchase_Order", "Generation_Date", "Method"], Field_list=[Gen_Fixed_Date_Row], Field_Blocking_dict=Fields_Blocking_dict, GUI_Level_ID=GUI_Level_ID) 
...
def PO_Price_Currency(Settings: dict, Configuration: dict|None, window: CTk|None, Frame: CTkFrame, GUI_Level_ID: int|None = None) -> WidgetFrame:
    ...
    Fields_Blocking_dict = CustomTkinter_Functions.Fields_Blocking(Values=["Fixed", "Purchase Order"], Freeze_fields=[[],[Fixed_Currency_Row]])
    Currency_Method_Row = WidgetRow_OptionMenu(Settings=Settings, Configuration=Configuration, master=Con_Price_Widget.Body_Frame, window=window, Field_Frame_Type="Single_Column", Label="Currency", Variable=Currency_Method_Variable, Values=Currency_Method_List, Save_To="Settings", Save_path=["0", "HQ_Data_Handler", "Confirmation", "Purchase_Order", "Currency", "Method"], Field_list=[Fixed_Currency_Row], Field_Blocking_dict=Fields_Blocking_dict, GUI_Level_ID=GUI_Level_ID) 
