...
def PO_Number(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame) -> CTkFrame:
    ...
    AUT_Prefix_Frame_Var.bind("<FocusOut>", lambda Entry_value: Defaults_Lists.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "Confirmation", "Purchase_Order", "Number", "Automatic_Options", "Prefix"], Information=AUT_Prefix_Frame_Var.get()))
    ...
    NUM_CON_FIX_Frame_Var.bind("<FocusOut>", lambda Entry_value: Defaults_Lists.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "Confirmation", "Purchase_Order", "Number", "Fixed_Options", "Number"], Information=NUM_CON_FIX_Frame_Var.get()))
...
def PO_Currency(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame) -> CTkFrame:
    ...
    Fixed_Currency_Frame_Var.bind("<FocusOut>", lambda Entry_value: Defaults_Lists.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "Confirmation", "Purchase_Order", "Currency", "Fixed_Options", "Fix_Currency"], Information=Fixed_Currency_Frame_Var.get()))
...
def PO_Line_Flags(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame) -> CTkFrame:
    ...
    Use_Line_Flags_Frame_Var.configure(variable=Line_Flags_Enabled_Variable, text="", command=lambda : Defaults_Lists.Save_Value(Settings=Settings, Configuration=None, Variable=Line_Flags_Enabled_Variable, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "Confirmation", "Purchase_Order", "Line_Flags", "Use"], Information=Line_Flags_Enabled_Variable))
    ...
    Use_Line_Flag_Label_Frame_Var.configure(variable=Line_Flag_Label_Enabled_Variable, text="", command=lambda : Defaults_Lists.Save_Value(Settings=Settings, Configuration=None, Variable=Line_Flag_Label_Enabled_Variable, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "Confirmation", "Purchase_Order", "Line_Flags", "Labels_always"], Information=Line_Flag_Label_Enabled_Variable))
...
def PO_ATP(Settings: dict, Configuration: dict, Frame: CTk|CTkFrame) -> CTkFrame:
    ...
    Use_ATP_Frame_Var.configure(variable=ATP_Enabled_Variable, text="", command=lambda : Defaults_Lists.Save_Value(Settings=Settings, Configuration=None, Variable=ATP_Enabled_Variable, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "Confirmation", "Purchase_Order", "ATP", "Use"], Information=ATP_Enabled_Variable))
    ...
    ATP_Max_Frame_Var.bind("<FocusOut>", lambda Entry_value: Defaults_Lists.Save_Value(Settings=Settings, Configuration=None, Variable=None, File_Name="Settings", JSON_path=["0", "HQ_Data_Handler", "Confirmation", "Purchase_Order", "ATP", "Max_ATP_Records"], Information=int(ATP_Max_Frame_Var.get())))
