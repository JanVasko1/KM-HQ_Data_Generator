...
def Page_Delivery(Settings: dict, Configuration: dict, Frame: CTkFrame):
    ...
    PO_Count_Widget = W_Delivery.DEL_Count(Settings=Settings, Configuration=Configuration, Frame=Frame_Tab_DEL1_Column_A, GUI_Level_ID=2)
    PO_Number_Widget = W_Delivery.DEL_Number(Settings=Settings, Configuration=Configuration, Frame=Frame_Tab_DEL1_Column_A, GUI_Level_ID=2)

    PO_Delivery_Date_Widget = W_Delivery.Delivery_Date(Settings=Settings, Configuration=Configuration, Frame=Frame_Tab_DEL1_Column_B, GUI_Level_ID=2)
    ...
    PO_Serial_Numbers_Widget = W_Delivery.Serial_Numbers(Settings=Settings, Configuration=Configuration, Frame=Frame_Tab_DEL2_Column_A, GUI_Level_ID=2)
    Ship_Method_Widget = W_Delivery.Shipment_Method(Settings=Settings, Configuration=Configuration, Frame=Frame_Tab_DEL2_Column_A, GUI_Level_ID=2)
    
    PO_Carrier_Widget = W_Delivery.Carrier_ID(Settings=Settings, Configuration=Configuration, Frame=Frame_Tab_DEL2_Column_B, GUI_Level_ID=2)
    BillOfLanding_Widget = W_Delivery.BillOfLanding(Settings=Settings, Configuration=Configuration, Frame=Frame_Tab_DEL2_Column_B, GUI_Level_ID=2)
    ...
    EXIDV2_Widget = W_Delivery.EXIDV2(Settings=Settings, Configuration=Configuration, Frame=Frame_Tab_T_P_Column_A, GUI_Level_ID=2)
    
    Pack_Items_Widget = W_Delivery.Packages_Items(Settings=Settings, Configuration=Configuration, Frame=Frame_Tab_T_P_Column_B, GUI_Level_ID=2)
