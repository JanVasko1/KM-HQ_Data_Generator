...
def Page_PreAdvice(Settings: dict, Configuration: dict|None, window: CTk|None, Frame: CTkFrame):
    # ------------------------- Main Functions -------------------------#
    # Define Frames
    ...
    PreAdvice_Del_Date_Widget = W_PreAdvice.Delivery_Date(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_Column_A, GUI_Level_ID=2)
    ...
    PreAdvice_Del_Date_Widget.Show()